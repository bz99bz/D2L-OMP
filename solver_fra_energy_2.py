...
def energy_guidence(x,adj,t,configt):
    ...
    #energy_drug = 2*mse(torch.tensor(qed_mean), torch.tensor(1.0))
    energy_validity = mse(torch.tensor(validity), torch.tensor(1.0))
    #print("energy_drug", energy_drug)
    print("energy_val", energy_validity)
    energy = energy_validity
    print("energy:", energy)
    # print("energy_w", li * weight_t * energy)
